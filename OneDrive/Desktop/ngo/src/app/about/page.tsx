...
export default function AboutPage() {
  ...
  const line = <div className="h-20 w-px bg-slate-400/50 self-center" />;
  const commentBoxes = [
    {
      id: 1,
      img: "/commentImg2.jpg",
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="px-12 my-30 flex gap-11  w-[98%] relative ">
        <Image
          src={"/aboutImg1.jpg"}
          width={200} height={200} alt="about image1"
          className="w-1/2 rounded-sm "
          objectFit="cover"
          objectPosition="center"
        />
        <div className="bg-white absolute bottom-6 left-16 flex gap-2 rounded-md ">
        ...
        <div className="w-1/2 ">
          ...
          <div className="border-b flex gap-5 pb-6">
            <ServiceDetails
      ...
      <div className="p-11 bg-black flex justify-between text-white">
        <div className="">
          <div className="translate-y-3">
            <HeartPulse className="text-red-500 " size={67} strokeWidth={1} />
          </div>
          <p className="pt-8 text-5xl font-extrabold">
            <Countup end={250} duration={4} /> <sup>+</sup>
          </p>
          <p className="font-medium mt-1.5">Satisfied Patients</p>
        </div>
        {line}
        <div className="">
          <div className="translate-y-3">
            <Cross className="text-red-500" size={65} strokeWidth={1} />
          </div>
          <p className="pt-8 text-5xl font-extrabold">
            <Countup end={315} duration={4} /><sup>+</sup>
          </p>
          <p className="font-medium mt-1.5">Health Sections</p>
        </div>
        {line}
        <div className="">
          <div className="translate-y-3">
            <MonitorCogIcon className="text-red-500" size={65} strokeWidth={1} />
          </div>
          <p className="pt-8 text-5xl font-bold"> <Countup end={180} duration={4} /><sup>+</sup></p>
          <p className="font-medium mt-1.5">Kinds of Research</p>
        </div>
        {line}
        <div className="">
          <div className="translate-y-3">
            <Drill className="text-red-500 " size={65} strokeWidth={1} />
          </div>
          <p className=" pt-8 text-5xl font-extrabold"> <Countup end={250} duration={4} /><sup>+</sup></p>
          <p className="font-medium mt-1.5">Award Winning</p>
        </div>
      </div>

      <div className="bg-white">
        <div className="mx-auto w-1/2 text-center mt-20 mb-10 space-y-2.5">
        ...
        <div className="px-12 flex gap-8 justify-center items-center">
